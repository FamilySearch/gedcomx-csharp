...
namespace Gx.Fs.Tree {
  ...
  public enum ChangeObjectType {
    ...
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Man")]
    Man,

    /// <summary>
    ///   The man in a couple relationship was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Woman")]
    Woman,

    /// <summary>
    ///   The father in a couple-child relationship was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Father")]
    Father,

    /// <summary>
    ///   The mother in a couple-child relationship was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Mother")]
    Mother,

    /// <summary>
    ///   The child in a couple-child relationship was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Child")]
    Child,

    /// <summary>
    ///   A source reference was changed.
    /// </summary>
    [XmlEnum("http://gedcomx.org/SourceReference")]
    SourceReference,
    ...
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/EvidenceReference")]
    EvidenceReference,

    /// <summary>
    ///   An affiliation fact was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/Affiliation")]
    Affiliation,
    ...
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/DiedBeforeEight")]
    DiedBeforeEight,

    /// <summary>
    ///   A tribe name fact was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/TribeName")]
    TribeName,

    /// <summary>
    ///   A birth order fact was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/BirthOrder")]
    BirthOrder,

    /// <summary>
    ///   A life sketch was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/LifeSketch")]
    LifeSketch,

    /// <summary>
    ///   A living status was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/LivingStatus")]
    LivingStatus,

    /// <summary>
    ///   A title of nobility fact was changed.
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/TitleOfNobility")]
    TitleOfNobility,

    /// <summary>
    ///   A not-a-match declaration
    /// </summary>
    [XmlEnum("http://familysearch.org/v1/NotAMatch")]
    NotAMatch
  }
}
