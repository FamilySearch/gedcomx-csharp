...
namespace Gx.Atom
{
    ...
    /// </summary>
    [Serializable]
    [XmlType(Namespace = "http://www.w3.org/2005/Atom", TypeName = "Entry")]
    [XmlRoot(Namespace = "http://www.w3.org/2005/Atom", ElementName = "entry")]
    public partial class Entry : Gx.Atom.ExtensibleElement, ISupportsLinks
    {

        private List<Gx.Atom.Person> _authors;
        private List<Gx.Atom.Category> _categories;
        private Gx.Search.ResultConfidence _confidence;
        private Gx.Atom.Content _content;
        private List<Gx.Atom.Person> _contributors;
        private string _id;
