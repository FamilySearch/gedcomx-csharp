...
namespace Gx.Agent
{
    ...
    /// </summary>
    [Serializable]
    [XmlType(Namespace = "http://gedcomx.org/v1/", TypeName = "Agent")]
    [XmlRoot(Namespace = "http://gedcomx.org/v1/", ElementName = "agent")]
    public partial class Agent : Gx.Links.HypermediaEnabledData
    {
        private List<Gx.Agent.OnlineAccount> _accounts;
        private List<Gx.Agent.Address> _addresses;
        private List<Gx.Common.ResourceReference> _emails;
        private Gx.Common.ResourceReference _homepage;
        private List<Gx.Conclusion.Identifier> _identifiers;
        private List<Gx.Common.TextValue> _names;
        private Gx.Common.ResourceReference _openid;
        private List<Gx.Common.ResourceReference> _phones;
        /// <summary>
        ///  The accounts that belong to this person or organization.
        /// </summary>
        [XmlElement(ElementName = "account", Namespace = "http://gedcomx.org/v1/")]
        [JsonProperty("accounts")]
        public List<Gx.Agent.OnlineAccount> Accounts
        {
            get
            {
        ...
        /// </summary>
        [XmlElement(ElementName = "address", Namespace = "http://gedcomx.org/v1/")]
        [JsonProperty("addresses")]
        public List<Gx.Agent.Address> Addresses
        {
            get
            {
        ...
        /// </summary>
        [XmlElement(ElementName = "email", Namespace = "http://gedcomx.org/v1/")]
        [JsonProperty("emails")]
        public List<Gx.Common.ResourceReference> Emails
        {
            get
            {
                return this._emails;
        ...
        ///  The homepage.
        /// </summary>
        [XmlElement(ElementName = "homepage", Namespace = "http://gedcomx.org/v1/")]
        ...
        [JsonProperty("names")]
        public List<Gx.Common.TextValue> Names
        {
            get
            {
                return this._names;
        ...
        /// </summary>
        [XmlElement(ElementName = "openid", Namespace = "http://gedcomx.org/v1/")]
        [JsonProperty("openid")]
        ...
        /// </summary>
        [XmlElement(ElementName = "phone", Namespace = "http://gedcomx.org/v1/")]
        [JsonProperty("phones")]
        public List<Gx.Common.ResourceReference> Phones
        {
            get
            {
                return this._phones;
