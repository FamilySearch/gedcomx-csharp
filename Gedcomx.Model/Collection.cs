...
namespace Gx.Records
{
    ...
    /// </summary>
    [Serializable]
    [XmlType(Namespace = "http://gedcomx.org/v1/", TypeName = "Collection")]
    [XmlRoot(Namespace = "http://gedcomx.org/v1/", ElementName = "collection")]
    public partial class Collection : Gx.Links.HypermediaEnabledData, IAttributable
    {
        ...
        private List<Gx.Records.CollectionContent> _content;
