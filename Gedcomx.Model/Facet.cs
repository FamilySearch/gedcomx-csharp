...
namespace Gx.Records
{
    ...
    public partial class Facet : Gx.Links.HypermediaEnabledData
    {
        ...
        public System.Collections.Generic.List<Gx.Records.Facet> Facets
        {
            get
            {
                return this._facets ?? (_facets = new System.Collections.Generic.List<Gx.Records.Facet>());
            }
            set
            {
                this._facets = value;
        ...
        public bool ShouldSerializeFacets() => AnyFacets();
        public bool AnyFacets()
        {
            return _facets?.Any() ?? false;
        }
        /// <summary>
        ...
        public System.Collections.Generic.List<Gx.Records.FacetValue> Values
        {
            get
            {
                return this._values ?? (_values = new System.Collections.Generic.List<Gx.Records.FacetValue>());
            }
            set
            {
                this._values = value;
