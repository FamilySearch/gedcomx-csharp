...
namespace Gx.Records
{
    ...
    public partial class FieldValueDescriptor : Gx.Links.HypermediaEnabledData
    {
        ...
        public System.Collections.Generic.List<Gx.Common.TextValue> DisplayLabels
        {
            get
            {
                return this._displayLabels ?? (_displayLabels = new System.Collections.Generic.List<Gx.Common.TextValue>());
            }
            set
            {
        ...
        public bool ShouldSerializeDisplayLabels() => AnyDisplayLabels();
        public bool AnyDisplayLabels()
        {
            return _displayLabels?.Any() ?? false;
        }
    }
}
