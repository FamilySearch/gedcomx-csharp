...
namespace Gx
{
    ...
    /// </summary>
    [Serializable]
    [XmlType(Namespace = "http://gedcomx.org/v1/", TypeName = "Gedcomx")]
    [XmlRoot(Namespace = "http://gedcomx.org/v1/", ElementName = "gedcomx")]
    public partial class Gedcomx : Gx.Links.HypermediaEnabledData
    {
        ...
        private List<Gx.Conclusion.Person> _persons;
        private List<Gx.Conclusion.Relationship> _relationships;
        private List<Gx.Source.SourceDescription> _sourceDescriptions;
        private List<Gx.Agent.Agent> _agents;
        private List<Gx.Conclusion.Event> _events;
        private List<Gx.Conclusion.PlaceDescription> _places;
        private List<Gx.Conclusion.Document> _documents;
        private List<Gx.Records.Collection> _collections;
        private List<Gx.Records.Field> _fields;
        private List<Gx.Records.RecordDescriptor> _recordDescriptors;
        /// <summary>
