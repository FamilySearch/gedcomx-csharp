...
namespace Gx.Types
{
    public enum NamePartQualifierType
    {
         ...
         */
        [XmlEnum("http://gedcomx.org/Title")]
        Title,
         ...
         */
        [XmlEnum("http://gedcomx.org/Postnom")]
        Postnom,
         ...
         */
        [XmlEnum("http://gedcomx.org/Particle")]
        Particle,
