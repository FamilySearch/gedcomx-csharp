...
namespace Gx.Source
{
    ...
    /// </summary>
    [Serializable]
    [XmlType(Namespace = "http://gedcomx.org/v1/", TypeName = "SourceDescription")]
    [XmlRoot(Namespace = "http://gedcomx.org/v1/", ElementName = "sourceDescription")]
    public partial class SourceDescription : Gx.Links.HypermediaEnabledData, IAttributable
    {
        ...
        private List<Gx.Source.SourceCitation> _citations;
        ...
        private List<Gx.Common.TextValue> _titles;
        ...
        private List<Gx.Source.Coverage> _coverage;
