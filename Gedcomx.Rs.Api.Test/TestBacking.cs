    ...
    public static class TestBacking
    {
        ...
        public static SourceReference GetPersonSourceReference()
        {
            return new SourceReference()
              .SetAttribution(new Attribution()
                ...
                .SetDescriptionRef("https://api-integ.familysearch.org/platform/sources/descriptions/MMH1-PNF");
        }
        ...
        public static Note GetCreateNote()
        {
            return new Note()
              ...
              .SetAttribution(new Attribution()
                .SetContributor(new ResourceReference("https://www.familysearch.org/platform/users/agents/MM6M-8QJ").SetResourceId("MM6M-8QJ")));
        }
        ...
        {
            return (Relationship)new Relationship().SetLink("relationship", new Uri("https://api-integ.familysearch.org/platform/tree/couple-relationships/XXX-XXXX"));
        }
        ...
        public static Byte[] GetCreatePdf()
        {
            ...
            _ = PdfWriter.GetInstance(doc, ms);
